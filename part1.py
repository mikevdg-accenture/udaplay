...
def setup_vector_db():
    ...
    if (api_key.startswith("voc")):
        embedding_fn = VocariumEmbeddingFunction(api_key=api_key, api_base="https://openai.vocareum.com/v1")
    else:
        embedding_fn = VocariumEmbeddingFunction(api_key=api_key, api_base=None)
